...
import radinyazilim.com.mhfz.Activities.MainActivity;
...
public class PushNotificationHandlerService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            sharedPreferences.edit().putString("comingData", sharedPreferences.getString("comingData", "") + ", " + remoteMessage.getData().toString()).commit();

            Log.d(TAG, "handleDataMessage: " + sharedPreferences.getString("comingData", ""));
